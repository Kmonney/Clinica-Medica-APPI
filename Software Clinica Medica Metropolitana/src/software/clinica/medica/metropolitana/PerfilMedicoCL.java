 ...
 * @author kmonn
 */
public class PerfilMedicoCL extends javax.swing.JFrame {

    /**
     * Creates new form PerfilMedicoCL
     */
    public PerfilMedicoCL() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PerfilMedicoCL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PerfilMedicoCL().setVisible(true);
            }
        });
    }
